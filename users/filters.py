...
class StudentFilter(django_filters.FilterSet):
    id_no = django_filters.CharFilter(
        field_name="user__username", lookup_expr="exact", label=""
    )
    name = django_filters.CharFilter(
        method="filter_by_name", label=""
    )
    email = django_filters.CharFilter(
        field_name="user__email", lookup_expr="icontains", label=""
    )
    Course = django_filters.CharFilter(
        field_name="program__name", lookup_expr="icontains", label=""
    )
